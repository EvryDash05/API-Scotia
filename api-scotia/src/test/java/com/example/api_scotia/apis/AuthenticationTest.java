package com.example.api_scotia.apis;

import com.example.api_scotia.constants.TestConstants;
...
public class AuthenticationTest {
    ...
    void login_success() throws Exception {
        String response =
                this.mockMvc
                        .perform(
                                MockMvcRequestBuilders.post("http://localhost:8080/api/v1/auth/login")
