...
(
    ...
    CONSTRAINT fk_loan_payment FOREIGN KEY (loan_id) REFERENCES tb_loan (loan_id)
);
...
INSERT INTO tb_card_type(type_id, name)
VALUES ('CRT001', 'Interbank'),
       ('CRT002', 'BCP'),
       ('CRT003', 'BBVA'),
       ('CRT004', 'Scotiabank'),
       ('CRT005', 'OH'),
...
(
    ...
    CONSTRAINT fk_card_type FOREIGN KEY (type_id) REFERENCES tb_card_type (type_id)
);
